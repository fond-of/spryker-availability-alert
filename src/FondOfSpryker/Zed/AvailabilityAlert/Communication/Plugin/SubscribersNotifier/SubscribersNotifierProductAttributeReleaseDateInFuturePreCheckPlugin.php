 ...
 */
class SubscribersNotifierProductAttributeReleaseDateInFuturePreCheckPlugin extends AbstractPlugin implements SubscribersNotifierPreCheckPluginInterface
{
    /**
    ...
    {
        return $this->getFacade()->preCheckSubscribersNotifierProductAttributeReleaseDateInFuture($availabilityAlertSubscriptionTransfer);
    }
}
